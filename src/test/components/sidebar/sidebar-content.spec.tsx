...
jest.mock('@/app/actions/prompt.actions', () => ({
  searchPromptAction: jest.fn(async (_prev, _formData) => ({
    success: true,
    prompts: [],
  })),
}));
...
describe('SidebarContent', () => {
  ...
  describe('Busca', () => {
    ...
    it('deveria iniciar o campo de busca com o search param', async () => {
      ...
      // hasQuery é true na montagem, então o useEffect dispara o server action;
      // drena o estado pendente dentro de act para não vazar o warning.
      await act(async () => {});
    });
  });
});
